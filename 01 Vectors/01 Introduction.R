...
v2<-c(TRUE,FALSE,TRUE, TRUE, FALSE)
cat("The boolean vector is ",v2)

v3<-v1[v2]

cat("Using the boolean as an index gives ",v3)

v4<-c("CT5102","CT561")

cat("The string vector is ",v4)
...
sample<-sample(1:3,20,replace=TRUE)
